...
export const MODE_COPY: Record<ModeId, ModeCopy> = {
  "run-the-table": {
    ...
    title: "RUN THE TABLE",
    description:
      "Draft exact NBA 3-year peak windows across a branching run, spend scarce credits, and beat five escalating statistical lineups — every battle decided by the five open PEAK3 components, with a full receipt.",
    meta: ["5 acts · 5 boss battles", "15–22 minutes", "No sign-in needed"],
    cta: "Start a run",
    group: "flagship",
    blurb: "Branching front-office run, five boss battles",
    badge: "Flagship",
    iconKey: "swords",
  },
  "peak-season": {
