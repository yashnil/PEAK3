...
export const MODE_COPY: Record<ModeId, ModeCopy> = {
  "run-the-table": {
    ...
    title: "RUN THE TABLE",
    description:
      "Draft exact NBA 3-year peak windows across a branching run, spend scarce credits, and beat four escalating statistical lineups — every battle decided by the five open PEAK3 components, with a full receipt.",
    meta: ["4 acts · 4 boss battles", "12–18 minutes", "No sign-in needed"],
    cta: "Start a run",
    group: "flagship",
    blurb: "Branching front-office run, four boss battles",
    badge: "Flagship",
    iconKey: "swords",
  },
  "peak-season": {
